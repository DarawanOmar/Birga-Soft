          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
              <TextEffect
                ...
                speedSegment={0.3}
                as="h1"
                className="mt-8 max-sm:mt-16 text-balance text-4xl sm:text-5xl md:text-7xl lg:mt-16 xl:text-[5rem] !leading-normal sm:-tracking-tighter font-bold"
              >
                {t("intro.hero.title")}
              </TextEffect>
              <TextEffect
              ...
              >
                ...
                >
                  <Link
                    href="https://birgastoresystem.vercel.app/sign-in"
                    target="_blank"
                  >
                    <span className="text-nowrap">
